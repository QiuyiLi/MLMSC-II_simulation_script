...
try:
      ...
      print ('script_astral_mlmsc.py -t <inputfile> -n <number of gene trees (default 20)> -r <number of resampling (default 5000)> -d <duplication rate> -l <loss rate> -c <effective population size multiplier (default 1)> -i <inference method (default ASTRAL)> ')
      sys.exit(2)
 
    
for opt, arg in opts:
      if opt == '-h':
         print ('script_astral_mlmsc.py -t <species tree file> -n <number of gene trees (default 20)> -r <number of resampling (default 5000)> -d <duplication rate> -l <loss rate> -c <effective population size multiplier (default 1)> -i <inference method (default ASTRAL)> ')
         sys.exit()
      elif opt in ("-t"):
         t = arg
      elif opt in ("-n"):
...
full_name = 'mlmsc_' + str(args_sim) + '_G' + str(n_gtree) + "_" + inference_method
